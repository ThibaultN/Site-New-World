...
?>
				<option value="<?php echo($produitId) ?>"><?php echo($typeLibelle." - ".$produitLibelle) ?></option>
<?php
			}
?>
				</select>
...
?>
					<option value="<?php echo($uniteId) ?>"><?php echo $uniteLibelle ?></option>
<?php
				}
?>
				</select>
		...
		<fieldset>
			<legend>Point de vente</legend>
				...
				<p>
					<label>Point de vente : </label><select name="lotPDV" id="PDV" list="listePDV" ></p>
	...
	//je créer ma requete vers le serveur php
	var request = new XMLHttpRequest();
