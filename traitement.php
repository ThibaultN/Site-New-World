...
if (isset($_POST['btValiderUtilisateur']) && $ok==true)
{
	...
	$requete="insert into utilisateur values ($numero,'$nom','$prenom','$pseudo','$rue','$dateNaiss','$CP','$ville','$telephone',password('$mdpu'),'$mail','$type','$clef',1)";
	//Execution de la requete
...
<?php
		//ATTENTION / L'ENVOIE DE MAIL NE FONCTIONNE PAS SUR UN SERVEUR LOCAL
		/*if(mail($mailDestinataire,"Email de confirmation - New World","Votre compte a bien été ajouté, pour confirmer votre inscription, cliquez sur le lien qui suit : localhost/world/site/validation.php?pseudo=$pseudo&cle=$clef"))
		{*/
?>
			<!-- <p>Un mail de confirmation vous à été envoyé a votre adresse éléctronique.</p> >
<?php
			/*mail($mailDestinataire,"Email de confirmation - New World","Votre compte a bien été ajouté, pour confirmer votre inscription, cliquez sur le lien qui suit : localhost/world/site/validation.php?pseudo=$pseudo&cle=$clef");
		}
		else
		{
?>
